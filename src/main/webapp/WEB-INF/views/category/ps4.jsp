...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
 	<div class="mainLeft">
		<div class="mainTitle">
			<a href="/board/list?bigcategory=${bigcategory }&category=${category}">PS4</a>
		</div>
		<ul class="title">
			<li class="title">
				정보 게시판
				<ul class="sub">
					<li class="sub Active"><a href="/board/list?bigcategory=${bigcategory }&category=4000" class="BGC-blue">유저 정보</a></li>
			...
			<li class="title">
				게임 게시판
				<ul class="sub">
					<li class="sub"><a href="/board/list?bigcategory=${bigcategory }&category=4003">게임 이야기</a></li>
