...
<div class="container">
  <form action="/gboard/update" method="POST" name="w_form">
    <input type="hidden" value="${gBoardVO.bNum}" name="bNum" />
    <input type="hidden" value="${page}" name="page" />
    <input type="hidden" value="${gBoardVO.year}" name="year" />
    <input type="hidden" value="${gBoardVO.month}" name="month" />
    <div class="form-group">
      <input name="bTitle" type="text" class="form-control" value="${gBoardVO.bTitle}">
    </div>
    <div class="form-group">
